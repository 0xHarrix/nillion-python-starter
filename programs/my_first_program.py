...
def nada_main():
    ...
    # Each creature votes for their favorite battle move (represented as integers)
    ...
    # Battle moves represented by integers 1, 2, 3, 4, 5
    # 1 = Magic Blast, 2 = Fire Breath, 3 = Healing Light, 4 = Water Wave, 5 = Lightning Strike
    ...
    # Determine the most popular battle move
